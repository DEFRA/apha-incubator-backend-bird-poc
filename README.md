# apha-incubator-backend-bird-poc
...
```bash
cd apha-incubator-backend-bird-poc
nvm use
```
...
```bash
docker build --no-cache --tag apha-incubator-backend-bird-poc .
```

Run:

```bash
docker run -e PORT=3001 -p 3001:3001 apha-incubator-backend-bird-poc
```
